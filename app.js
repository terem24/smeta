...
const app = {
    ...
    renderScheme: function () {
        ...
        // 3. Общая магистраль (только если есть хотя бы один котел)
        if (hasGasBoiler || hasElBoiler) {
        ...
        if (s.hotWater) {
            ...
            // Используем tank_heating как трубы подключения к бойлеру
            layers.push('tank_heating.png');

            // Бак ГВС (если есть в смете)
