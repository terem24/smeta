...
const app = {
    ...
    renderScheme: function () {
        ...
        // Генерация HTML с обработчиком ошибок загрузки картинок и выравниванием
        ...
        layers.forEach(layer => {
            ...
            html += `<img src="${basePath}${layer}" alt="${layer}" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; object-position: ${position};" onerror="this.style.display='none'">`;
        });
        html += `</div>`;
        return html;
    },
