...
const app = {
    ...
    sendEmail: async function () {
        ...
        try {
            ...
            const EMAILJS_SERVICE_ID = "service_id"; // ID сервиса
            const EMAILJS_TEMPLATE_ID = "template_id"; // ID шаблона
            const EMAILJS_PUBLIC_KEY = "public_key"; // Публичный ключ из раздела Account
            ...
            if (result.status === 200) {
                alert("✅ Смета успешно сохранена и отправлена на почту!");
            } else {
