    ...
    render: function () {
        ...
        if (this.state.userAddedEq && this.state.userAddedEq.length > 0) {
            this.state.userAddedEq.forEach(eq => {
                // ДЕЙСТВИЕ 1: Убираем дублирование иконок из названия. Оставляем только крестик и имя.
                // Иконка теперь генерируется в getImg (unnamed.jpg)
                ...
                // ДЕЙСТВИЕ 1: Передаем пустую строку в качестве бренда.
