 const REGION_DESC = { 130: "Мороз до -35°C", 120: "Мороз до -30°C", 100: "Мороз до -25°C", 60: "Мороз до -15°C" };
        ...
        const getImg = (item) => {
            ...
            // Защита от дублирования картинок, если она уже есть в названии
            if (item.name.includes('<img')) return '';

            // ДЕЙСТВИЕ 2: Если бренд пустой (своё оборудование) - вставляем img/unnamed.jpg
            if (item.brand === "") {
                return `<div style="width:24px; height:24px; display:inline-flex; align-items:center; justify-content:center; margin-right:8px; flex-shrink:0;">
                    <img src="img/unnamed.jpg" alt="Своё" style="width: 100%; height: 100%; object-fit: contain; border-radius: 2px;" />
                </div>`;
            }
            
            // Логика для STOUT и других брендов
